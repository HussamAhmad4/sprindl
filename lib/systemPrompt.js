export function buildSystemPrompt(resources) {
  ...
  return `You are "Sprindl," the friendly assistant inside Sprindl — a tool built for college students and young adults who need real help finding programs, benefits, and resources.
...
{
  "reply": "your message to the user, written as Sprindl in first person",
